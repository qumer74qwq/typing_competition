...
// Get cookies
// getCookie('attempts') === '' ? setAttempts('attempts') : setAttempts(getCookie('attempts'));
...
// default settings
let lang = GetArgsFromHref(window.location.href, "lang");
if (lang == "zh") {
  setLanguage("chinese");
} else {
  setLanguage("english");
...
setTypingMode("time");
// disallow
document.querySelector("#redo-button").hidden = true;
